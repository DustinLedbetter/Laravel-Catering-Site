...
<div id="contactForm" class="w3-container w3-padding- w3-sand">
  <div class="w3-row">
	...
	<form class="w3-container w3-card-4 w3-light-grey">
      ...
      <div class="w3-group">
        <label class="w3-label-c1">Email  (Not required, but we will be unable to respond back without one)</label>
        <input class="w3-input" type="text">
      </div>
      <div class="w3-group">
        <label class="w3-label-c1">Message</label>
		<textarea class="w3-input w3-border" style="resize:none" required></textarea>
      </div>
