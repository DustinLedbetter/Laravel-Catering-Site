...
<!-- Head Section -->
<head>
  <title>About Peace of Cake</title>
  <!-- Meta Tags -->
  <meta charset="UTF-8">
...
<div id="navBig" class="w3-top">
  <ul class="w3-navbar w3-theme-d2 w3-left-align">
    ...
    <li class="w3-hide-small w3-mobile"><a href="/about" class="w3-light-grey">About</a></li>
  ...
  <div id="navSmall" class="w3-hide w3-hide-large w3-hide-medium">
    <ul class="w3-navbar w3-left-align w3-theme-d2">
      ...
      <li><a href="/about" class="w3-light-grey">About</a></li>
...
<!-- History Container -->
<div id="historyAboutPage" class="w3-container">
  <div class="w3-content" style="max-width:1500px">
    <h1 class="w3-center w3-padding-64"><span class="w3-tag w3-wide w3-theme-d2">Our History</span></h1>
...
<!-- Team Section -->
<div id="team" class="w3-container w3-padding-24">
  <h3 class="w3-center"><span class="w3-tag w3-wide w3-theme-d2">THE  WONDERFUL TEAM</span></h3>
  <div class="w3-row-padding" style="margin-top:64px">
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card-2">
        <img src="imgs/person_icon.png" style="width:100%" alt="pic of person">
...
<!-- Work Stats Section -->
<div id="workStats" class="w3-container">
  <h3 class="w3-center"><span class="w3-tag w3-wide w3-theme-d2">OUR WORK</h3>
  <p class="w3-center w3-large">What we've done for people so far</p>
  ...
  <!-- First Photo Grid -->
  <div id="photoGridOneAboutPage" class="w3-row-padding" style="margin-top:64px">
    <div class="w3-col m3">
  ...
  <!-- Second Photo Grid -->
  <div id="photoGridTwoAboutPage" class="w3-row-padding w3-section">
    <div class="w3-col m3">
      <img src="imgs/pie1.jpg" style="width:100%" onclick="onClick(this)" class="w3-hover-opacity" alt="pic of a item served">
    </div>
    <div class="w3-col m3">
...
<div id="footer" class="w3-cell-row w3-theme-d2">
  <div class="w3-container w3-cell w3-left w3-theme-d2">
	...
	<br><a href="#aboutPage" class="w3-hover-opacity">Return to Top</a>
	</p>
  </div>
